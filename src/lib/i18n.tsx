...
const en: Dict = {
  ...
  "nav.search": "Search",
  "nav.labs": "Labs",
  "nav.guide": "Product Guide",
  "guide.title": "Product Guide",
  "guide.subtitle": "Pick a product and a standard to see the required tests, acceptable limits and BIS labs.",
  "guide.product": "Product",
  "guide.standard": "Standard",
  "guide.tests": "Required tests",
  "guide.limit": "Acceptable limit",
  "guide.method": "Test method",
  "guide.clause": "Clause",
  "guide.labs": "BIS recognized labs",
  "guide.clauses": "Clause extracts",
  "guide.noTests": "No test requirements recorded for this standard yet. Ask BISmart or check the clause extracts below.",
  "guide.noLabs": "No lab matched this scope. Try the full lab finder.",
  "guide.pickPrompt": "Choose a product to begin.",
  ...
  "tour.1.title": "Welcome to BISmart",
  "tour.1.body": "Ask anything about Indian Standards and BIS certification — in English, Hindi or Telugu. Every answer carries source citations.",
  "tour.1.cta": "Try the chat",
  "tour.2.title": "Find your standard",
  "tour.2.body": "Describe your product and BISmart recommends the applicable standards, whether they are mandatory, and the right certification scheme.",
  "tour.2.cta": "Open recommender",
  "tour.3.title": "Judge tip: Demo Mode",
  "tour.3.body": "Press Shift+D anytime for a floating panel with three one-click demo queries — no typing needed.",
  "tour.next": "Next",
  ...
  "common.verified": "Verified source",
  "common.high": "High",
...
const hi: Dict = {
  ...
  "nav.guide": "उत्पाद गाइड",
  "guide.title": "उत्पाद गाइड",
  "guide.subtitle": "आवश्यक परीक्षण, स्वीकार्य सीमाएँ और BIS प्रयोगशालाएँ देखने के लिए उत्पाद और मानक चुनें।",
  "guide.product": "उत्पाद",
  "guide.standard": "मानक",
  "guide.tests": "आवश्यक परीक्षण",
  "guide.limit": "स्वीकार्य सीमा",
  "guide.method": "परीक्षण विधि",
  "guide.clause": "खंड",
  "guide.labs": "BIS मान्यता प्राप्त प्रयोगशालाएँ",
  "guide.clauses": "खंड अंश",
  "guide.noTests": "इस मानक के लिए अभी कोई परीक्षण आवश्यकता दर्ज नहीं है। BISmart से पूछें या नीचे खंड अंश देखें।",
  "guide.noLabs": "इस स्कोप से कोई प्रयोगशाला मेल नहीं खाई। पूर्ण प्रयोगशाला खोज देखें।",
  "guide.pickPrompt": "शुरू करने के लिए उत्पाद चुनें।",
  "guide.loading": "लोड हो रहा है…",
  "nav.about": "परिचय",
  "nav.theme": "थीम बदलें",
  ...
  "tour.1.title": "BISmart में आपका स्वागत है",
  "tour.1.body": "भारतीय मानकों और BIS प्रमाणन के बारे में कुछ भी पूछें — English, हिंदी या తెలుగు में। हर उत्तर के साथ स्रोत उद्धरण होते हैं।",
  "tour.1.cta": "चैट आज़माएँ",
  "tour.2.title": "अपना मानक खोजें",
  "tour.2.body": "अपने उत्पाद का वर्णन करें — BISmart लागू मानक, अनिवार्यता और सही प्रमाणन योजना बताता है।",
  "tour.2.cta": "सिफ़ारिश खोलें",
  "tour.3.title": "डेमो मोड",
  "tour.3.body": "कभी भी Shift+D दबाएँ — तीन वन-क्लिक डेमो प्रश्नों वाला पैनल खुलता है, टाइप करने की ज़रूरत नहीं।",
  "tour.next": "आगे",
  "tour.done": "शुरू करें",
  "tour.skip": "छोड़ें",
  "chat.sources": "स्रोत",
  ...
  "common.verified": "सत्यापित स्रोत",
  "common.high": "उच्च",
  "common.medium": "मध्यम",
  "common.low": "निम्न",
};
...
const te: Dict = {
  ...
  "nav.search": "వెతుకు",
  "nav.labs": "ల్యాబ్‌లు",
  "nav.guide": "ఉత్పత్తి గైడ్",
  "guide.title": "ఉత్పత్తి గైడ్",
  "guide.subtitle": "అవసరమైన పరీక్షలు, ఆమోదయోగ్య పరిమితులు మరియు BIS ల్యాబ్‌లు చూడటానికి ఉత్పత్తి మరియు ప్రమాణాన్ని ఎంచుకోండి.",
  "guide.product": "ఉత్పత్తి",
  "guide.standard": "ప్రమాణం",
  "guide.tests": "అవసరమైన పరీక్షలు",
  "guide.limit": "ఆమోదయోగ్య పరిమితి",
  "guide.method": "పరీక్ష విధానం",
  "guide.clause": "క్లాజ్",
  "guide.labs": "BIS గుర్తింపు పొందిన ల్యాబ్‌లు",
  "guide.clauses": "క్లాజ్ భాగాలు",
  "guide.noTests": "ఈ ప్రమాణానికి ఇంకా పరీక్ష అవసరాలు నమోదు కాలేదు. BISmart ని అడగండి లేదా కింద క్లాజ్ భాగాలు చూడండి.",
  "guide.noLabs": "ఈ స్కోప్‌కు ల్యాబ్ సరిపోలలేదు. పూర్తి ల్యాబ్ ఫైండర్ చూడండి.",
  "guide.pickPrompt": "ప్రారంభించడానికి ఉత్పత్తిని ఎంచుకోండి.",
  "guide.loading": "లోడ్ అవుతోంది…",
  "nav.about": "గురించి",
  ...
  "tour.1.title": "BISmart కు స్వాగతం",
  "tour.1.body": "భారతీయ ప్రమాణాలు మరియు BIS ధృవీకరణ గురించి ఏదైనా అడగండి — English, హిందీ లేదా తెలుగులో. ప్రతి సమాధానంతో మూలాల ఉల్లేఖనాలు ఉంటాయి.",
  "tour.1.cta": "చాట్ ప్రయత్నించండి",
  "tour.2.title": "మీ ప్రమాణాన్ని కనుగొనండి",
  "tour.2.body": "మీ ఉత్పత్తిని వివరించండి — BISmart వర్తించే ప్రమాణాలు, తప్పనిసరి అయ్యేదేనా, సరైన ధృవీకరణ పథకం చెబుతుంది.",
  "tour.2.cta": "సిఫార్సు తెరవండి",
  "tour.3.title": "డెమో మోడ్",
  "tour.3.body": "ఎప్పుడైనా Shift+D నొక్కండి — మూడు వన్-క్లిక్ డెమో ప్రశ్నలతో ఫ్లోటింగ్ ప్యానెల్ తెరుస్తుంది.",
  "tour.next": "తదుపరి",
  "tour.done": "ప్రారంభించండి",
  "tour.skip": "దాటవేయి",
  "chat.sources": "మూలాలు",
  ...
  "common.verified": "ధృవీకరించిన మూలం",
  "common.high": "ఎక్కువ",
